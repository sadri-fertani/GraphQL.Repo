...
namespace GraphQL.SocialNetwork.Services
{
    public class BlogService
    {
        ...
        private readonly List<SocialNet> sns = new List<SocialNet>();
        ...
        public List<SocialNet> GetSNsByAuthor(int id)
        {
            return sns.Where(sn => sn.Author.Id == id).ToList<SocialNet>();
        }
    }
}
